...
async function currentWeather(e,input){
    ...
    try{
        const data = await axios(`https://cors-anywhere.herokuapp.com/https://api.openweathermap.org/data/2.5/${e}?APPID=beac49ede1be043d3509a4d55c800063&q=${input}&units=imperial`);
